...
<body style="background-color:  white; font-family: 'Poppins', sans-serif;">
  <div class="content" align="center" style="
    ...
    <div class="welcome" style="
      max-width: 100%;
      font-size:  2em;">
      <h2 style="font-weight: normal; line-height: 1em;"><?=$username?>,</h2>
      <h2 style="font-weight: normal; line-height: 1em;">Bienvenue sur MineBump.com !</h2>
    </div>
    ...
    <div class="check_now" style="
      ...
      font-size:  1.1em;
      ">Veuillez confirmer votre adresse mail afin de valider votre inscription.</p>
      <a href="https://minebump.com/account/mailconfirm/<?=urlencode($user_id)?>" style="
      font-size:  0.9em;
      padding: 10px 15px;
